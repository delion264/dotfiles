...
" Show line numbers and set colour
set number
set cursorline
set cursorlineopt=number
highlight LineNr term=NONE cterm=NONE ctermfg=darkcyan guifg=DarkGrey gui=NONE cterm=NONE
highlight CursorLineNr cterm=NONE ctermfg=white guifg=#af6600
